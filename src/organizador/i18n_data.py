...
EN_STRINGS: dict[str, str] = {
    ...
    "Adiciona pelo menos uma extensão aceite.": "Add at least one accepted extension.",
    "A pasta de dados da aplicação não pôde ser validada.": "The application data folder could not be validated.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar uma dentro da outra.": "The University and Downloads folders cannot coincide or contain each other.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar dentro da pasta de dados da aplicação.": "The University and Downloads folders cannot coincide or sit inside the application data folder.",
    "O tamanho mínimo não pode ser negativo.": "The minimum size cannot be negative.",
    "O tempo do popup deve ser de pelo menos 10 segundos.": "The popup timeout must be at least 10 seconds.",
    "O aviso de prazos deve estar entre 0 e 30 dias.": "Deadline reminders must be between 0 and 30 days.",
    "O tema escolhido não existe: {theme}": "The chosen theme does not exist: {theme}",
    "O idioma escolhido não existe: {language}": "The chosen language does not exist: {language}",
    "A pasta {label} tem de ser um caminho absoluto e não pode estar vazia.": "The {label} folder must be an absolute path and cannot be empty.",
    "A pasta {label} não pôde ser validada.": "The {label} folder could not be validated.",
    "A pasta {label} não pode ser a raiz do disco.": "The {label} folder cannot be the drive root.",
    "O modelo do nome não pode estar vazio.": "The name template cannot be empty.",
    "O modelo do nome é demasiado longo (máximo 120 caracteres).": "The name template is too long (maximum 120 characters).",
    "O modelo do nome tem chaves por fechar.": "The name template has unclosed braces.",
    "Token desconhecido no modelo do nome: {token}": "Unknown token in the name template: {token}",
...
ES_STRINGS: dict[str, str] = {
    ...
    "Adiciona pelo menos uma extensão aceite.": "Añade al menos una extensión aceptada.",
    "A pasta de dados da aplicação não pôde ser validada.": "No se pudo validar la carpeta de datos de la aplicación.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar uma dentro da outra.": "Las carpetas Universidad y Descargas no pueden coincidir ni contenerse.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar dentro da pasta de dados da aplicação.": "Las carpetas Universidad y Descargas no pueden coincidir ni quedar dentro de la carpeta de datos.",
    "O tamanho mínimo não pode ser negativo.": "El tamaño mínimo no puede ser negativo.",
    "O tempo do popup deve ser de pelo menos 10 segundos.": "El tiempo del aviso debe ser de al menos 10 segundos.",
    "O aviso de prazos deve estar entre 0 e 30 dias.": "Los avisos de plazos deben estar entre 0 y 30 días.",
    "O tema escolhido não existe: {theme}": "El tema elegido no existe: {theme}",
    "O idioma escolhido não existe: {language}": "El idioma elegido no existe: {language}",
    "A pasta {label} tem de ser um caminho absoluto e não pode estar vazia.": "La carpeta {label} debe ser una ruta absoluta y no puede estar vacía.",
    "A pasta {label} não pôde ser validada.": "No se pudo validar la carpeta {label}.",
    "A pasta {label} não pode ser a raiz do disco.": "La carpeta {label} no puede ser la raíz del disco.",
    "O modelo do nome não pode estar vazio.": "La plantilla de nombre no puede estar vacía.",
    "O modelo do nome é demasiado longo (máximo 120 caracteres).": "La plantilla de nombre es demasiado larga (máximo 120 caracteres).",
    "O modelo do nome tem chaves por fechar.": "La plantilla de nombre tiene llaves sin cerrar.",
    "Token desconhecido no modelo do nome: {token}": "Token desconocido en la plantilla de nombre: {token}",
...
FR_STRINGS: dict[str, str] = {
    ...
    "Adiciona pelo menos uma extensão aceite.": "Ajoute au moins une extension acceptée.",
    "A pasta de dados da aplicação não pôde ser validada.": "Impossible de valider le dossier de données de l'application.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar uma dentro da outra.": "Les dossiers Université et Téléchargements ne peuvent ni coïncider ni s'imbriquer.",
    "As pastas Universidade e Downloads não podem coincidir nem ficar dentro da pasta de dados da aplicação.": "Les dossiers Université et Téléchargements ne peuvent coïncider ni s'imbriquer dans le dossier de données.",
    "O tamanho mínimo não pode ser negativo.": "La taille minimale ne peut pas être négative.",
    "O tempo do popup deve ser de pelo menos 10 segundos.": "Le délai du pop-up doit être d'au moins 10 secondes.",
    "O aviso de prazos deve estar entre 0 e 30 dias.": "Les rappels d'échéances doivent être entre 0 et 30 jours.",
    "O tema escolhido não existe: {theme}": "Le thème choisi n'existe pas : {theme}",
    "O idioma escolhido não existe: {language}": "La langue choisie n'existe pas : {language}",
    "A pasta {label} tem de ser um caminho absoluto e não pode estar vazia.": "Le dossier {label} doit être un chemin absolu et ne peut être vide.",
    "A pasta {label} não pôde ser validada.": "Impossible de valider le dossier {label}.",
    "A pasta {label} não pode ser a raiz do disco.": "Le dossier {label} ne peut pas être la racine du disque.",
    "O modelo do nome não pode estar vazio.": "Le modèle de nom ne peut pas être vide.",
    "O modelo do nome é demasiado longo (máximo 120 caracteres).": "Le modèle de nom est trop long (maximum 120 caractères).",
    "O modelo do nome tem chaves por fechar.": "Le modèle de nom contient des accolades non fermées.",
    "Token desconhecido no modelo do nome: {token}": "Jeton inconnu dans le modèle de nom : {token}",
